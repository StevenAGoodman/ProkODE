...
def create_tfbs_through_CiiiDER(prokode_dir, jar_loc, promoters_loc, promoters_len, matrices_loc, threshold, add_betas):
...
def preprocessing_main(prokode_dir, genome_loc, annotation_loc, operons_loc, pfm_database_loc, CiiiDER_jar_loc, CiiiDER_thresh, add_betas=False):
    ...
    tfbs_loc = create_tfbs_through_CiiiDER(prokode_dir, CiiiDER_jar_loc, promoters_loc, promoters_len, motif_matrix_loc, CiiiDER_thresh, add_betas)
