...
data_dir = "C:/Users/cryst/LOFScreening/archive/PROKODE/ProkODE/beta_training/GEO_expression_data"
...
for data_file in files_list[2:]:
    ...
    if len(search_df) != 0:
        ...
        search_df.insert(0,"geneid",  pd.Series(), allow_duplicates=True)
...
big_df.to_csv("C:/Users/cryst/LOFScreening/archive/PROKODE/ProkODE/beta_training/GEO_expression_data/data.csv")